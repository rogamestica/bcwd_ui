      ...
      <Card.Body className='p-3 m-3 mb-5 pb-5'>
        <Card.Title className='pt-2'>
          <div className="element-class-news">
            <h3 className="myheader-news pt-2 text-lg"  style={{fontFamily: 'Roboto', fontSize: '30px'}}>DAILY WATER SERVICE INTERRUPTION ADVISORY STARTING MARCH 28</h3>
          </div>
        </Card.Title>
        <div className='pb-3'>
          <span className='fw-normal text-secondary date' style={{fontFamily: 'Roboto-Light', fontSize: '20px'}}>March 27, 2023</span>
        </div>
        <Card.Text className='py-2' style={{fontFamily: 'Roboto-Light', fontSize: '20px'}}>
