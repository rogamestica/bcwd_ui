      ...
      <Container className="px-4 pb-5">
        <Row className="mx-4">
          ...
          <Col xs={12} className="mt-4 pt-4">
            <h3 className="header2" style={{ fontFamily: 'Roboto', fontSize: '30px' }}>Scheduled Water Service Interruptions</h3>
            <Paragraph descript="Butuan City Water District continuously conducts preventive maintenance activities and pipe installations, among others, to improve and expand the water infrastructure and thus sustain good service levels for its customers. To allow the implementation of these activities, however, water service must sometimes be interrupted or water pressure is reduced. Visit this page to check on water service advisories in your area." />
          </Col>
